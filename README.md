...
![Version](http://img.shields.io/badge/version-5.0.2-blue.svg)
...
Pin a version: `SIGNALER_VERSION=5.0.2 curl -fsSL …/install.sh | bash`
...
- uses: ./.github/actions/signaler
  with:
    version: "5.0.2"   # GitHub Release tag, or "latest"
