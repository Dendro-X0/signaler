...
![Version](http://img.shields.io/badge/version-5.1.0-blue.svg)
...
Pin a version: `SIGNALER_VERSION=5.1.0 curl -fsSL …/install.sh | bash`
...
- uses: ./.github/actions/signaler
  with:
    version: "5.1.0"   # GitHub Release tag, or "latest"
