...
- [Phase 2 — v4.2 Team CI](roadmap/phase2-v4.2-team-ci.md)
...
- [Accuracy](reference/accuracy.md)
- [Testing](reference/testing.md)
- [Contracts: V3](reference/contracts-v3.md)
- [Contracts: V4](reference/contracts-v4.md)
...
- [Production Playbook](operations/production-playbook.md)
- [Launch Checklist](operations/launch-checklist.md)
- [Release Playbook](operations/release-playbook.md)
- [Release Notes](operations/release-notes.md)
- [JSR Optimization](operations/jsr-optimization.md)
...
- [Phase 2 — v4.2 Team CI](roadmap/phase2-v4.2-team-ci.md)
- [GitHub Actions](guides/github-actions.md)
- [Phase 1 — v4.1 Adoptability](roadmap/phase1-v4.1-adoptability.md) (shipped)
- [B2B Team Value](guides/b2b-team-value.md)
...
- [V6 Blueprint](specs/v6-blueprint.md)
- [Rust Network Workers](specs/rust-network-workers.md)

## Examples

- [Basic Usage](examples/basic-usage.md)
- [Agent Prompt Pack](examples/agent-prompt-pack.md)
