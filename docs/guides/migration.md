...
If your repo still uses `apex.config.json`, rename it to `signaler.config.json` and verify fields against [configuration reference](../reference/configuration.md).
...
Do not assume CLI config shape equals programmatic API config shape. See [API reference](../reference/api.md).
...
- [V3 Deprecation Matrix](../archive/notes/v3-deprecation-matrix.md)
