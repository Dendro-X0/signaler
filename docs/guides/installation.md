...
```bash
SIGNALER_VERSION=5.1.4 curl -fsSL …/install.sh | bash
```
...
```bash
SIGNALER_VERSION=5.1.4 curl -fsSL https://raw.githubusercontent.com/Dendro-X0/signaler/main/release-assets/install.sh | bash
```
