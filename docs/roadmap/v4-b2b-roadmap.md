...
v5.0.0  shipped   quality profiles — Lighthouse + side runners + pack gate
```
...
| **5** | v5.0.0 | Quality profiles | Shipped — [`phase4-v5.0-quality-profiles.md`](./phase4-v5.0-quality-profiles.md) |
