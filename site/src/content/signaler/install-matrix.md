...
Use the GitHub Release installers or the [GitHub Action](/docs/signaler/github-actions) in CI.
...
See [GitHub Actions guide](/docs/signaler/github-actions).
...
- [Known limits](/docs/signaler/known-limits) — distribution and scoring caveats
