...
This folder is organized around stable documentation categories first, with versioned history moved under `docs/archive`.
...
- [API Reference](/docs/signaler/api-reference)
...
- [Guides Index](/docs/signaler/README)
- [Getting Started](/docs/signaler/getting-started)
- [Agent Quickstart](/docs/signaler/agent-quickstart)
- [Migration](/docs/signaler/migration)
...
- [Reference Index](/docs/signaler/README)
- [CLI](/docs/signaler/cli)
- [Configuration](/docs/signaler/configuration)
- [API](/docs/signaler/api-reference)
- [Features](/docs/signaler/FEATURES)
- [Accuracy](/docs/signaler/accuracy)
- [Testing](/docs/signaler/testing)
- [Contracts: V3](/docs/signaler/contracts-v3)
- [Contracts: V4](/docs/signaler/contracts-v4)

## Operations

- [Operations Index](/docs/signaler/README)
- [SLO](/docs/signaler/slo)
- [Performance Baseline](/docs/signaler/performance-baseline)
- [Production Playbook](/docs/signaler/production-playbook)
- [Launch Checklist](/docs/signaler/launch-checklist)
- [Release Playbook](/docs/signaler/release-playbook)
- [Release Notes](/docs/signaler/release-notes)
- [JSR Optimization](/docs/signaler/jsr-optimization)
...
- [Basic Usage](/docs/signaler/basic-usage)
- [Agent Prompt Pack](/docs/signaler/agent-prompt-pack)
- [CLI Usage](/docs/signaler/cli-usage)
- [Configuration Examples](/docs/signaler/configuration-examples)
- [Framework Integration](/docs/signaler/framework-integration)
- [Advanced Usage](/docs/signaler/advanced-usage)

## Archive

- [Archived Roadmaps](archive/roadmaps)
- [Archived Specs](archive/specs)
- [Archived Release Notes](archive/release-notes)
- [Archived Notes](archive/notes)
