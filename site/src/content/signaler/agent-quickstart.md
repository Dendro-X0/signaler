...
For model-specific prompt variants, see [`../examples/agent-prompt-pack.md`](/docs/signaler/agent-prompt-pack).
Repository-level agent defaults are also available in [`../../AGENTS.md`](/docs/signaler/AGENTS).
Shell-specific bootstrap blocks are available in [`../../scripts/agent-bootstrap.md`](/docs/signaler/agent-bootstrap).
...
- [`../examples/agent-prompt-pack.md`](/docs/signaler/agent-prompt-pack)
