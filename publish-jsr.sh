#!/bin/bash
# Signaler v2.5.2 JSR Publishing Script

echo "🚀 Publishing Signaler CLI v2.5.2 to JSR..."
...
if [ $? -eq 0 ]; then
    echo "🎉 Successfully published @signaler/cli@2.5.2 to JSR!"
    echo ""
    echo "📋 Next steps:"
    echo "1. Verify at: https://jsr.io/@signaler/cli"
    echo "2. Test installation: npx jsr add @signaler/cli@2.5.2"
